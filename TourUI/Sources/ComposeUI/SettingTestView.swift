...
//  previewよう。coredataでpreviewが正常に動かないため、対処用
//
...
public struct SettingTestView: View {
    // MARK: - PROPERTIES
...
//        }
//        .alert("バックアップデータが正常に復元されました。", isPresented: $restoreFinish){
//            Button("了解"){
...
//            }
//        } message: {
//            Text("完全に読み込まれるまでに1分ほどかかる場合があります。")
//        }
        
    }
}

struct SettingTestView_Previews: PreviewProvider {
